...
public final class Localization {
    ...
    /** e.g. keyString("tooltip", "eaten_status.not_eaten_1") -> "tooltip.solonion.eatenStatus.not_eaten_1") */
    public static String keyString(String domain, String path) {
        return domain + "." + SOLOnion.MODID + "." + path;
    }
    ...
    public static String localizedQuantity(String domain, String path, int number) {
        return number == 1 ? I18n.get(keyString(domain, path + ".singular")) : I18n.get(keyString(domain, path + ".plural"), number);
    }
    
    public static MutableComponent localizedQuantityComponent(String domain, String path, int number) {
        return number == 1 ? Component.translatable(keyString(domain, path + ".singular")) : Component.translatable(keyString(domain, path + ".plural"), number);
    }
