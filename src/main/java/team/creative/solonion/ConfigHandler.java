...
import team.creative.solonion.tracking.benefits.Benefit;
import team.creative.solonion.tracking.benefits.BenefitList;
import team.creative.solonion.utils.BenefitsParser;
import team.creative.solonion.utils.ComplexityParser;
...
public class ConfigHandler {
    ...
    public static void onServerStart(ServerStartingEvent event) {
        complexityMap = ComplexityParser.parse(SOLOnionConfig.getComplexityUnparsed());
        thresholds = SOLOnionConfig.getThresholds();
        List<List<Benefit>> benefits = BenefitsParser.parse(SOLOnionConfig.getBenefitsUnparsed());
    ...
    public static void syncConfig(Player player) {
        ...
        SOLOnion.NETWORK.sendToClient(new ConfigMessage(ConfigHandler.serializeConfig()), (ServerPlayer) player);
    }
}
